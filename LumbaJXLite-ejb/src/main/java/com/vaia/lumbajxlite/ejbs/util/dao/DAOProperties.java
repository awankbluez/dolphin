 ...
 */
package com.vaia.lumbajxlite.ejbs.util.dao;
...
public class DAOProperties {
     ...
     *
     * @param specificKey The specific key which is to be used as property key
     * prefix.
     * @throws DAOConfigurationException During class initialization if the DAO
